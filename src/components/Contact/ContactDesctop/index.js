...
export default function ContactDesctop() {
  ...
  return (
    <>
      ...
      <div className="info-map">
        ...
        Bulgaria, <br />
        Sofia <br />
        <span onClick={focusInput}>sergeylavrenov93@gmail.com</span>
      </div>
      <div className="map-wrap">
        <MapContainer
          center={[42.6970803, 23.3103172]}
          zoom={4}
          zoomControl={false}
        >
          <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
          <Marker position={[42.6970803, 23.3103172]}></Marker>
        </MapContainer>
      </div>
